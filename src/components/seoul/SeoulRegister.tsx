import SeoulRegisterForm from "./SeoulRegisterForm";

export default function SeoulRegister({ source }: { source?: string }) {
  return (
    <section id="register" className="snap-section relative py-20 sm:py-32 md:py-40">
      <div className="max-w-3xl mx-auto px-6 sm:px-10">
        ...
        <SeoulRegisterForm source={source} />
      </div>
    </section>
  );
}
